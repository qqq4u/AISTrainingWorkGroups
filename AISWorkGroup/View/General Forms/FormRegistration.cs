    ...
    public partial class FormRegistration : Form
    {
        ...
        private void buttonRegister_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    reader.Close();
                    DBConnector.mySqlCommand.CommandText = $@"INSERT `users`(login, password, full_name, role, position, email, date_of_birth, phone_number) VALUES ('{textBoxLogin.Text}','{textBoxPassword.Text}','{textBoxFullName.Text}', {comboBoxRole.SelectedIndex}, '{textBoxPosition.Text}', '{textBoxEmail.Text}', '{dateTimePickerBirthDate.Value:yyyy-MM-dd}', '{textBoxPhoneNumber.Text}')";
